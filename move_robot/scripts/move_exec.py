...
def main():
	...
	home_init = lab_invk(0.275, 0.15, 0.1, 0)
	

	if(move_home == True):
		rospy.loginfo("Moving robot ...\n")
		move_arm(pub_command, loop_rate, home_init, vel, accel)
	...
	def on_press(key):
		if(key == keyboard.Key.up):
			...
			print("Non-direction key is pressed!")
	...
	def on_release(key):
		...
		if(key == keyboard.Key.up):
			...
			print("Non-direction key is released!")


		if key == keyboard.Key.esc:
			print("Esc key is pressed! Exit!")
			return False
